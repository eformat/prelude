...
const COUNTRIES = [
  ...
  { code: "AD", dial: "+376", name: "Andorra", flag: "\u{1F1E6}\u{1F1E9}" },
  { code: "AO", dial: "+244", name: "Angola", flag: "\u{1F1E6}\u{1F1F4}" },
  { code: "AG", dial: "+1268", name: "Antigua and Barbuda", flag: "\u{1F1E6}\u{1F1EC}" },
  { code: "AR", dial: "+54", name: "Argentina", flag: "\u{1F1E6}\u{1F1F7}" },
  { code: "AM", dial: "+374", name: "Armenia", flag: "\u{1F1E6}\u{1F1F2}" },
  { code: "AT", dial: "+43", name: "Austria", flag: "\u{1F1E6}\u{1F1F9}" },
  { code: "AZ", dial: "+994", name: "Azerbaijan", flag: "\u{1F1E6}\u{1F1FF}" },
  { code: "BS", dial: "+1242", name: "Bahamas", flag: "\u{1F1E7}\u{1F1F8}" },
  { code: "BH", dial: "+973", name: "Bahrain", flag: "\u{1F1E7}\u{1F1ED}" },
  { code: "BD", dial: "+880", name: "Bangladesh", flag: "\u{1F1E7}\u{1F1E9}" },
  { code: "BB", dial: "+1246", name: "Barbados", flag: "\u{1F1E7}\u{1F1E7}" },
  { code: "BY", dial: "+375", name: "Belarus", flag: "\u{1F1E7}\u{1F1FE}" },
  { code: "BE", dial: "+32", name: "Belgium", flag: "\u{1F1E7}\u{1F1EA}" },
  { code: "BZ", dial: "+501", name: "Belize", flag: "\u{1F1E7}\u{1F1FF}" },
  { code: "BJ", dial: "+229", name: "Benin", flag: "\u{1F1E7}\u{1F1EF}" },
  { code: "BT", dial: "+975", name: "Bhutan", flag: "\u{1F1E7}\u{1F1F9}" },
  { code: "BO", dial: "+591", name: "Bolivia", flag: "\u{1F1E7}\u{1F1F4}" },
  { code: "BA", dial: "+387", name: "Bosnia and Herzegovina", flag: "\u{1F1E7}\u{1F1E6}" },
  { code: "BW", dial: "+267", name: "Botswana", flag: "\u{1F1E7}\u{1F1FC}" },
  { code: "BR", dial: "+55", name: "Brazil", flag: "\u{1F1E7}\u{1F1F7}" },
  { code: "BN", dial: "+673", name: "Brunei", flag: "\u{1F1E7}\u{1F1F3}" },
  { code: "BG", dial: "+359", name: "Bulgaria", flag: "\u{1F1E7}\u{1F1EC}" },
  { code: "BF", dial: "+226", name: "Burkina Faso", flag: "\u{1F1E7}\u{1F1EB}" },
  { code: "BI", dial: "+257", name: "Burundi", flag: "\u{1F1E7}\u{1F1EE}" },
  { code: "CV", dial: "+238", name: "Cabo Verde", flag: "\u{1F1E8}\u{1F1FB}" },
  { code: "KH", dial: "+855", name: "Cambodia", flag: "\u{1F1F0}\u{1F1ED}" },
  { code: "CM", dial: "+237", name: "Cameroon", flag: "\u{1F1E8}\u{1F1F2}" },
  { code: "CA", dial: "+1", name: "Canada", flag: "\u{1F1E8}\u{1F1E6}" },
  { code: "CF", dial: "+236", name: "Central African Republic", flag: "\u{1F1E8}\u{1F1EB}" },
  { code: "TD", dial: "+235", name: "Chad", flag: "\u{1F1F9}\u{1F1E9}" },
  ...
  { code: "KM", dial: "+269", name: "Comoros", flag: "\u{1F1F0}\u{1F1F2}" },
  { code: "CG", dial: "+242", name: "Congo", flag: "\u{1F1E8}\u{1F1EC}" },
  { code: "CD", dial: "+243", name: "Congo (DRC)", flag: "\u{1F1E8}\u{1F1E9}" },
  { code: "CR", dial: "+506", name: "Costa Rica", flag: "\u{1F1E8}\u{1F1F7}" },
  { code: "CI", dial: "+225", name: "Côte d'Ivoire", flag: "\u{1F1E8}\u{1F1EE}" },
  { code: "HR", dial: "+385", name: "Croatia", flag: "\u{1F1ED}\u{1F1F7}" },
  { code: "CU", dial: "+53", name: "Cuba", flag: "\u{1F1E8}\u{1F1FA}" },
  { code: "CY", dial: "+357", name: "Cyprus", flag: "\u{1F1E8}\u{1F1FE}" },
  { code: "CZ", dial: "+420", name: "Czech Republic", flag: "\u{1F1E8}\u{1F1FF}" },
  { code: "DK", dial: "+45", name: "Denmark", flag: "\u{1F1E9}\u{1F1F0}" },
  { code: "DJ", dial: "+253", name: "Djibouti", flag: "\u{1F1E9}\u{1F1EF}" },
  { code: "DM", dial: "+1767", name: "Dominica", flag: "\u{1F1E9}\u{1F1F2}" },
  { code: "DO", dial: "+1809", name: "Dominican Republic", flag: "\u{1F1E9}\u{1F1F4}" },
  { code: "EC", dial: "+593", name: "Ecuador", flag: "\u{1F1EA}\u{1F1E8}" },
  { code: "EG", dial: "+20", name: "Egypt", flag: "\u{1F1EA}\u{1F1EC}" },
  { code: "SV", dial: "+503", name: "El Salvador", flag: "\u{1F1F8}\u{1F1FB}" },
  { code: "GQ", dial: "+240", name: "Equatorial Guinea", flag: "\u{1F1EC}\u{1F1F6}" },
  { code: "ER", dial: "+291", name: "Eritrea", flag: "\u{1F1EA}\u{1F1F7}" },
  { code: "EE", dial: "+372", name: "Estonia", flag: "\u{1F1EA}\u{1F1EA}" },
  { code: "SZ", dial: "+268", name: "Eswatini", flag: "\u{1F1F8}\u{1F1FF}" },
  { code: "ET", dial: "+251", name: "Ethiopia", flag: "\u{1F1EA}\u{1F1F9}" },
  { code: "FJ", dial: "+679", name: "Fiji", flag: "\u{1F1EB}\u{1F1EF}" },
  { code: "FI", dial: "+358", name: "Finland", flag: "\u{1F1EB}\u{1F1EE}" },
  { code: "FR", dial: "+33", name: "France", flag: "\u{1F1EB}\u{1F1F7}" },
  { code: "GA", dial: "+241", name: "Gabon", flag: "\u{1F1EC}\u{1F1E6}" },
  { code: "GM", dial: "+220", name: "Gambia", flag: "\u{1F1EC}\u{1F1F2}" },
  { code: "GE", dial: "+995", name: "Georgia", flag: "\u{1F1EC}\u{1F1EA}" },
  ...
  { code: "GD", dial: "+1473", name: "Grenada", flag: "\u{1F1EC}\u{1F1E9}" },
  { code: "GT", dial: "+502", name: "Guatemala", flag: "\u{1F1EC}\u{1F1F9}" },
  { code: "GN", dial: "+224", name: "Guinea", flag: "\u{1F1EC}\u{1F1F3}" },
  { code: "GW", dial: "+245", name: "Guinea-Bissau", flag: "\u{1F1EC}\u{1F1FC}" },
  { code: "GY", dial: "+592", name: "Guyana", flag: "\u{1F1EC}\u{1F1FE}" },
  { code: "HT", dial: "+509", name: "Haiti", flag: "\u{1F1ED}\u{1F1F9}" },
  { code: "HN", dial: "+504", name: "Honduras", flag: "\u{1F1ED}\u{1F1F3}" },
  { code: "HK", dial: "+852", name: "Hong Kong", flag: "\u{1F1ED}\u{1F1F0}" },
  { code: "HU", dial: "+36", name: "Hungary", flag: "\u{1F1ED}\u{1F1FA}" },
  { code: "IS", dial: "+354", name: "Iceland", flag: "\u{1F1EE}\u{1F1F8}" },
  { code: "IN", dial: "+91", name: "India", flag: "\u{1F1EE}\u{1F1F3}" },
  { code: "ID", dial: "+62", name: "Indonesia", flag: "\u{1F1EE}\u{1F1E9}" },
  { code: "IR", dial: "+98", name: "Iran", flag: "\u{1F1EE}\u{1F1F7}" },
  { code: "IQ", dial: "+964", name: "Iraq", flag: "\u{1F1EE}\u{1F1F6}" },
  ...
  { code: "JM", dial: "+1876", name: "Jamaica", flag: "\u{1F1EF}\u{1F1F2}" },
  { code: "JP", dial: "+81", name: "Japan", flag: "\u{1F1EF}\u{1F1F5}" },
  { code: "JO", dial: "+962", name: "Jordan", flag: "\u{1F1EF}\u{1F1F4}" },
  { code: "KZ", dial: "+7", name: "Kazakhstan", flag: "\u{1F1F0}\u{1F1FF}" },
  { code: "KE", dial: "+254", name: "Kenya", flag: "\u{1F1F0}\u{1F1EA}" },
  { code: "KI", dial: "+686", name: "Kiribati", flag: "\u{1F1F0}\u{1F1EE}" },
  { code: "KW", dial: "+965", name: "Kuwait", flag: "\u{1F1F0}\u{1F1FC}" },
  { code: "KG", dial: "+996", name: "Kyrgyzstan", flag: "\u{1F1F0}\u{1F1EC}" },
  { code: "LA", dial: "+856", name: "Laos", flag: "\u{1F1F1}\u{1F1E6}" },
  { code: "LV", dial: "+371", name: "Latvia", flag: "\u{1F1F1}\u{1F1FB}" },
  { code: "LB", dial: "+961", name: "Lebanon", flag: "\u{1F1F1}\u{1F1E7}" },
  { code: "LS", dial: "+266", name: "Lesotho", flag: "\u{1F1F1}\u{1F1F8}" },
  { code: "LR", dial: "+231", name: "Liberia", flag: "\u{1F1F1}\u{1F1F7}" },
  { code: "LY", dial: "+218", name: "Libya", flag: "\u{1F1F1}\u{1F1FE}" },
  { code: "LI", dial: "+423", name: "Liechtenstein", flag: "\u{1F1F1}\u{1F1EE}" },
  { code: "LT", dial: "+370", name: "Lithuania", flag: "\u{1F1F1}\u{1F1F9}" },
  { code: "LU", dial: "+352", name: "Luxembourg", flag: "\u{1F1F1}\u{1F1FA}" },
  { code: "MG", dial: "+261", name: "Madagascar", flag: "\u{1F1F2}\u{1F1EC}" },
  { code: "MW", dial: "+265", name: "Malawi", flag: "\u{1F1F2}\u{1F1FC}" },
  { code: "MY", dial: "+60", name: "Malaysia", flag: "\u{1F1F2}\u{1F1FE}" },
  { code: "MV", dial: "+960", name: "Maldives", flag: "\u{1F1F2}\u{1F1FB}" },
  { code: "ML", dial: "+223", name: "Mali", flag: "\u{1F1F2}\u{1F1F1}" },
  { code: "MT", dial: "+356", name: "Malta", flag: "\u{1F1F2}\u{1F1F9}" },
  { code: "MH", dial: "+692", name: "Marshall Islands", flag: "\u{1F1F2}\u{1F1ED}" },
  { code: "MR", dial: "+222", name: "Mauritania", flag: "\u{1F1F2}\u{1F1F7}" },
  { code: "MU", dial: "+230", name: "Mauritius", flag: "\u{1F1F2}\u{1F1FA}" },
  { code: "MX", dial: "+52", name: "Mexico", flag: "\u{1F1F2}\u{1F1FD}" },
  { code: "FM", dial: "+691", name: "Micronesia", flag: "\u{1F1EB}\u{1F1F2}" },
  { code: "MD", dial: "+373", name: "Moldova", flag: "\u{1F1F2}\u{1F1E9}" },
  { code: "MC", dial: "+377", name: "Monaco", flag: "\u{1F1F2}\u{1F1E8}" },
  { code: "MN", dial: "+976", name: "Mongolia", flag: "\u{1F1F2}\u{1F1F3}" },
  { code: "ME", dial: "+382", name: "Montenegro", flag: "\u{1F1F2}\u{1F1EA}" },
  { code: "MA", dial: "+212", name: "Morocco", flag: "\u{1F1F2}\u{1F1E6}" },
  { code: "MZ", dial: "+258", name: "Mozambique", flag: "\u{1F1F2}\u{1F1FF}" },
  { code: "MM", dial: "+95", name: "Myanmar", flag: "\u{1F1F2}\u{1F1F2}" },
  { code: "NA", dial: "+264", name: "Namibia", flag: "\u{1F1F3}\u{1F1E6}" },
  { code: "NR", dial: "+674", name: "Nauru", flag: "\u{1F1F3}\u{1F1F7}" },
  { code: "NP", dial: "+977", name: "Nepal", flag: "\u{1F1F3}\u{1F1F5}" },
  { code: "NL", dial: "+31", name: "Netherlands", flag: "\u{1F1F3}\u{1F1F1}" },
  { code: "NZ", dial: "+64", name: "New Zealand", flag: "\u{1F1F3}\u{1F1FF}" },
  { code: "NI", dial: "+505", name: "Nicaragua", flag: "\u{1F1F3}\u{1F1EE}" },
  { code: "NE", dial: "+227", name: "Niger", flag: "\u{1F1F3}\u{1F1EA}" },
  { code: "NG", dial: "+234", name: "Nigeria", flag: "\u{1F1F3}\u{1F1EC}" },
  { code: "KP", dial: "+850", name: "North Korea", flag: "\u{1F1F0}\u{1F1F5}" },
  { code: "MK", dial: "+389", name: "North Macedonia", flag: "\u{1F1F2}\u{1F1F0}" },
  { code: "NO", dial: "+47", name: "Norway", flag: "\u{1F1F3}\u{1F1F4}" },
  { code: "OM", dial: "+968", name: "Oman", flag: "\u{1F1F4}\u{1F1F2}" },
  { code: "PK", dial: "+92", name: "Pakistan", flag: "\u{1F1F5}\u{1F1F0}" },
  { code: "PW", dial: "+680", name: "Palau", flag: "\u{1F1F5}\u{1F1FC}" },
  { code: "PS", dial: "+970", name: "Palestine", flag: "\u{1F1F5}\u{1F1F8}" },
  { code: "PA", dial: "+507", name: "Panama", flag: "\u{1F1F5}\u{1F1E6}" },
  { code: "PG", dial: "+675", name: "Papua New Guinea", flag: "\u{1F1F5}\u{1F1EC}" },
  { code: "PY", dial: "+595", name: "Paraguay", flag: "\u{1F1F5}\u{1F1FE}" },
  ...
  { code: "QA", dial: "+974", name: "Qatar", flag: "\u{1F1F6}\u{1F1E6}" },
  { code: "RO", dial: "+40", name: "Romania", flag: "\u{1F1F7}\u{1F1F4}" },
  { code: "RU", dial: "+7", name: "Russia", flag: "\u{1F1F7}\u{1F1FA}" },
  { code: "RW", dial: "+250", name: "Rwanda", flag: "\u{1F1F7}\u{1F1FC}" },
  { code: "KN", dial: "+1869", name: "Saint Kitts and Nevis", flag: "\u{1F1F0}\u{1F1F3}" },
  { code: "LC", dial: "+1758", name: "Saint Lucia", flag: "\u{1F1F1}\u{1F1E8}" },
  { code: "VC", dial: "+1784", name: "Saint Vincent and the Grenadines", flag: "\u{1F1FB}\u{1F1E8}" },
  { code: "WS", dial: "+685", name: "Samoa", flag: "\u{1F1FC}\u{1F1F8}" },
  { code: "SM", dial: "+378", name: "San Marino", flag: "\u{1F1F8}\u{1F1F2}" },
  { code: "ST", dial: "+239", name: "São Tomé and Príncipe", flag: "\u{1F1F8}\u{1F1F9}" },
  { code: "SA", dial: "+966", name: "Saudi Arabia", flag: "\u{1F1F8}\u{1F1E6}" },
  { code: "SN", dial: "+221", name: "Senegal", flag: "\u{1F1F8}\u{1F1F3}" },
  { code: "RS", dial: "+381", name: "Serbia", flag: "\u{1F1F7}\u{1F1F8}" },
  { code: "SC", dial: "+248", name: "Seychelles", flag: "\u{1F1F8}\u{1F1E8}" },
  { code: "SL", dial: "+232", name: "Sierra Leone", flag: "\u{1F1F8}\u{1F1F1}" },
  { code: "SG", dial: "+65", name: "Singapore", flag: "\u{1F1F8}\u{1F1EC}" },
  { code: "SK", dial: "+421", name: "Slovakia", flag: "\u{1F1F8}\u{1F1F0}" },
  { code: "SI", dial: "+386", name: "Slovenia", flag: "\u{1F1F8}\u{1F1EE}" },
  { code: "SB", dial: "+677", name: "Solomon Islands", flag: "\u{1F1F8}\u{1F1E7}" },
  { code: "SO", dial: "+252", name: "Somalia", flag: "\u{1F1F8}\u{1F1F4}" },
  { code: "ZA", dial: "+27", name: "South Africa", flag: "\u{1F1FF}\u{1F1E6}" },
  { code: "KR", dial: "+82", name: "South Korea", flag: "\u{1F1F0}\u{1F1F7}" },
  { code: "SS", dial: "+211", name: "South Sudan", flag: "\u{1F1F8}\u{1F1F8}" },
  { code: "ES", dial: "+34", name: "Spain", flag: "\u{1F1EA}\u{1F1F8}" },
  { code: "LK", dial: "+94", name: "Sri Lanka", flag: "\u{1F1F1}\u{1F1F0}" },
  { code: "SD", dial: "+249", name: "Sudan", flag: "\u{1F1F8}\u{1F1E9}" },
  { code: "SR", dial: "+597", name: "Suriname", flag: "\u{1F1F8}\u{1F1F7}" },
  { code: "SE", dial: "+46", name: "Sweden", flag: "\u{1F1F8}\u{1F1EA}" },
  { code: "CH", dial: "+41", name: "Switzerland", flag: "\u{1F1E8}\u{1F1ED}" },
  { code: "SY", dial: "+963", name: "Syria", flag: "\u{1F1F8}\u{1F1FE}" },
  { code: "TW", dial: "+886", name: "Taiwan", flag: "\u{1F1F9}\u{1F1FC}" },
  { code: "TJ", dial: "+992", name: "Tajikistan", flag: "\u{1F1F9}\u{1F1EF}" },
  { code: "TZ", dial: "+255", name: "Tanzania", flag: "\u{1F1F9}\u{1F1FF}" },
  { code: "TH", dial: "+66", name: "Thailand", flag: "\u{1F1F9}\u{1F1ED}" },
  { code: "TL", dial: "+670", name: "Timor-Leste", flag: "\u{1F1F9}\u{1F1F1}" },
  { code: "TG", dial: "+228", name: "Togo", flag: "\u{1F1F9}\u{1F1EC}" },
  { code: "TO", dial: "+676", name: "Tonga", flag: "\u{1F1F9}\u{1F1F4}" },
  { code: "TT", dial: "+1868", name: "Trinidad and Tobago", flag: "\u{1F1F9}\u{1F1F9}" },
  { code: "TN", dial: "+216", name: "Tunisia", flag: "\u{1F1F9}\u{1F1F3}" },
  { code: "TR", dial: "+90", name: "Turkey", flag: "\u{1F1F9}\u{1F1F7}" },
  { code: "TM", dial: "+993", name: "Turkmenistan", flag: "\u{1F1F9}\u{1F1F2}" },
  { code: "TV", dial: "+688", name: "Tuvalu", flag: "\u{1F1F9}\u{1F1FB}" },
  { code: "UG", dial: "+256", name: "Uganda", flag: "\u{1F1FA}\u{1F1EC}" },
  ...
  { code: "UY", dial: "+598", name: "Uruguay", flag: "\u{1F1FA}\u{1F1FE}" },
  { code: "UZ", dial: "+998", name: "Uzbekistan", flag: "\u{1F1FA}\u{1F1FF}" },
  { code: "VU", dial: "+678", name: "Vanuatu", flag: "\u{1F1FB}\u{1F1FA}" },
  { code: "VA", dial: "+379", name: "Vatican City", flag: "\u{1F1FB}\u{1F1E6}" },
  { code: "VE", dial: "+58", name: "Venezuela", flag: "\u{1F1FB}\u{1F1EA}" },
  { code: "VN", dial: "+84", name: "Vietnam", flag: "\u{1F1FB}\u{1F1F3}" },
  { code: "YE", dial: "+967", name: "Yemen", flag: "\u{1F1FE}\u{1F1EA}" },
  { code: "ZM", dial: "+260", name: "Zambia", flag: "\u{1F1FF}\u{1F1F2}" },
  { code: "ZW", dial: "+263", name: "Zimbabwe", flag: "\u{1F1FF}\u{1F1FC}" },
];
